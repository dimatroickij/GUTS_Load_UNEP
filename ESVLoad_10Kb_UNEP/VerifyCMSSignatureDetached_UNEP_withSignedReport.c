VerifyCMSSignatureDetached_UNEP_withSignedReport()
{
	...
	{
        lr_end_transaction("VerifyCMSSignatureDetached_UNEP_withSignedReport", LR_FAIL);
	...
	{
		lr_end_transaction("VerifyCMSSignatureDetached_UNEP_withSignedReport", LR_PASS);
	}
