# 1 "c:\\lr_scripts_unep\\esvload_sertswithsignedreport_unep\\\\combined_ESVLoad_SertsWithSignedReport_UNEP.c"
...
# 1 "c:\\lr_scripts_unep\\esvload_sertswithsignedreport_unep\\\\combined_ESVLoad_SertsWithSignedReport_UNEP.c" 2
...
# 2 "c:\\lr_scripts_unep\\esvload_sertswithsignedreport_unep\\\\combined_ESVLoad_SertsWithSignedReport_UNEP.c" 2
...
# 3 "c:\\lr_scripts_unep\\esvload_sertswithsignedreport_unep\\\\combined_ESVLoad_SertsWithSignedReport_UNEP.c" 2
...
# 5 "c:\\lr_scripts_unep\\esvload_sertswithsignedreport_unep\\\\combined_ESVLoad_SertsWithSignedReport_UNEP.c" 2

# 1 "VerifyCertificate_withSignedReport_UNEP.c" 1
VerifyCertificate_withSignedReport_UNEP()
{
	...
	{
        lr_end_transaction("VerifyCertificate_UNEP_withSignedReport", 1);
		lr_error_message( lr_eval_string("error: expected contains {VerifyCertificate_withSignedReport_response}, but got {result}"));
	}
	else
	{
		lr_end_transaction("VerifyCertificate_UNEP_withSignedReport", 0);
	}
    
	lr_continue_on_error(0);
    return 0;
}
# 6 "c:\\lr_scripts_unep\\esvload_sertswithsignedreport_unep\\\\combined_ESVLoad_SertsWithSignedReport_UNEP.c" 2
...
# 7 "c:\\lr_scripts_unep\\esvload_sertswithsignedreport_unep\\\\combined_ESVLoad_SertsWithSignedReport_UNEP.c" 2
