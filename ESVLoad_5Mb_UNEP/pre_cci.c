# 1 "c:\\lr_scripts_unep\\esvload_5mb_unep\\\\combined_ESVLoad_5Mb_UNEP.c"
...
# 1 "c:\\lr_scripts_unep\\esvload_5mb_unep\\\\combined_ESVLoad_5Mb_UNEP.c" 2
...
# 2 "c:\\lr_scripts_unep\\esvload_5mb_unep\\\\combined_ESVLoad_5Mb_UNEP.c" 2
...
# 1 "C:\\Program Files (x86)\\HPE\\LoadRunner\\include/wssoap.h" 1
...
# 77 "C:\\Program Files (x86)\\HPE\\LoadRunner\\include/wssoap.h"
...
# 240 "C:\\Program Files (x86)\\HPE\\LoadRunner\\include/wssoap.h"
...
# 278 "C:\\Program Files (x86)\\HPE\\LoadRunner\\include/wssoap.h"
...
# 311 "C:\\Program Files (x86)\\HPE\\LoadRunner\\include/wssoap.h"
...
# 340 "C:\\Program Files (x86)\\HPE\\LoadRunner\\include/wssoap.h"
...
# 386 "C:\\Program Files (x86)\\HPE\\LoadRunner\\include/wssoap.h"
...
# 418 "C:\\Program Files (x86)\\HPE\\LoadRunner\\include/wssoap.h"
...
# 3 "c:\\lr_scripts_unep\\esvload_5mb_unep\\\\combined_ESVLoad_5Mb_UNEP.c" 2
...
# 5 "c:\\lr_scripts_unep\\esvload_5mb_unep\\\\combined_ESVLoad_5Mb_UNEP.c" 2

# 1 "VerifyCMSSignature_UNEP_simple.c" 1
VerifyCMSSignature_UNEP_simple()
{
	web_cache_cleanup();
	...
	if(strstr( lr_eval_string("{result}"), lr_eval_string("{VerifyCMSSignature_simple_response}"))==0)
	{
        lr_end_transaction("VerifyCMSSignature_UNEP_simple", 1);
		lr_output_message( lr_eval_string("error: expected contains {VerifyCMSSignature_simple_response}, but got {result}"));
	}
	else
	{
		lr_end_transaction("VerifyCMSSignature_UNEP_simple", 0);
	}
	
    lr_continue_on_error(0);
	return 0;
}
# 6 "c:\\lr_scripts_unep\\esvload_5mb_unep\\\\combined_ESVLoad_5Mb_UNEP.c" 2

# 1 "VerifyCMSSignature_UNEP_withSignedReport.c" 1
VerifyCMSSignature_UNEP_withSignedReport()
{
	web_cache_cleanup();
	web_cleanup_auto_headers();
	web_cleanup_cookies();
	...
	if(strstr( lr_eval_string("{result}"), lr_eval_string("{VerifyCMSSignature_withSignedReport_response}"))==0)
	{
        lr_end_transaction("VerifyCMSSignature_UNEP_withSignedReport", 1);
		lr_output_message( lr_eval_string("error: expected contains {VerifyCMSSignature_withSignedReport_response}, but got {result}"));
	}
	else
	{
		lr_end_transaction("VerifyCMSSignature_UNEP_withSignedReport", 0);
	}
	
    lr_continue_on_error(0);
	return 0;
}
# 7 "c:\\lr_scripts_unep\\esvload_5mb_unep\\\\combined_ESVLoad_5Mb_UNEP.c" 2

# 1 "VerifyCMSSignatureByHash_UNEP_simple.c" 1
VerifyCMSSignatureByHash_UNEP_simple()
{
	web_cache_cleanup();
	web_cleanup_auto_headers();
	web_cleanup_cookies();
	...
	if(strstr( lr_eval_string("{result}"), lr_eval_string("{VerifyCMSSignatureByHash_simple_response}"))==0)
	{
        lr_end_transaction("VerifyCMSSignatureByHash_UNEP_simple", 1);
		lr_output_message( lr_eval_string("error: expected contains {VerifyCMSSignatureByHash_simple_response}, but got {result}"));
	}
	else
	{
		lr_end_transaction("VerifyCMSSignatureByHash_UNEP_simple", 0);
	}
	lr_continue_on_error(0);
	return 0;
}
# 8 "c:\\lr_scripts_unep\\esvload_5mb_unep\\\\combined_ESVLoad_5Mb_UNEP.c" 2

# 1 "VerifyCMSSignatureByHash_UNEP_withSignedReport.c" 1
VerifyCMSSignatureByHash_UNEP_withSignedReport()
{
	...
	if(strstr( lr_eval_string("{result}"), lr_eval_string("{VerifyCMSSignatureByHash_withSignedReport_response}"))==0)
	{
        lr_end_transaction("VerifyCMSSignatureByHash_UNEP_withSignedReport", 1);
	...
	{
		lr_end_transaction("VerifyCMSSignatureByHash_UNEP_withSignedReport", 0);
	}
    lr_continue_on_error(0);
	return 0;
}
# 9 "c:\\lr_scripts_unep\\esvload_5mb_unep\\\\combined_ESVLoad_5Mb_UNEP.c" 2

# 1 "VerifyCMSSignatureDetached_UNEP_simple.c" 1
VerifyCMSSignatureDetached_UNEP_simple()
{
	web_cache_cleanup();
	web_cleanup_auto_headers();
	web_cleanup_cookies();

	lr_output_message(	lr_eval_string("{dataPath}/{VerifyCMSSignatureDetached_simple_file}"));
	lr_read_file(lr_eval_string("{dataPath}/{VerifyCMSSignatureDetached_simple_file}"), "request", 0);

	lr_output_message("Use file: {VerifyCMSSignatureDetached_simple_file}");

	lr_continue_on_error(1);
	
	lr_start_transaction("VerifyCMSSignatureDetached_UNEP_simple");
	soap_request("StepName=VerifyCMSSignatureDetached_UNEP_simple",
		"URL={URL}",
		"SOAPEnvelope="
			"{request}",
		"ExpectedResponse=AnySoap",
	...
	if(strstr( lr_eval_string("{result}"), lr_eval_string("{VerifyCMSSignatureDetached_simple_response}"))==0)
	{
        lr_end_transaction("VerifyCMSSignatureDetached_UNEP_simple", 1);
		lr_output_message( lr_eval_string("error: expected contains {VerifyCMSSignatureDetached_simple_response}, but got {result}"));
	}
	else
	{
		lr_end_transaction("VerifyCMSSignatureDetached_UNEP_simple", 0);
	}
    
    lr_continue_on_error(0);
	return 0;
}
# 10 "c:\\lr_scripts_unep\\esvload_5mb_unep\\\\combined_ESVLoad_5Mb_UNEP.c" 2

# 1 "VerifyCMSSignatureDetached_UNEP_withSignedReport.c" 1
VerifyCMSSignatureDetached_UNEP_withSignedReport()
{
	...
	lr_start_transaction("VerifyCMSSignatureDetached_UNEP_withSignedReport");
	soap_request("StepName=VerifyCMSSignatureDetached_UNEP_withSignedReport",
		"URL={URL}",
		"SOAPEnvelope="
			"{request}",
		"ExpectedResponse=AnySoap",
	...
	if(strstr( lr_eval_string("{result}"), lr_eval_string("{VerifyCMSSignatureDetached_withSignedReport_response}"))==0)
	{
        lr_end_transaction("VerifyCMSSignatureDetached_UNEP_withSignedReport", 1);
	...
	{
		lr_end_transaction("VerifyCMSSignatureDetached_UNEP_withSignedReport", 0);
	}
    
    lr_continue_on_error(0);
	return 0;
}
# 11 "c:\\lr_scripts_unep\\esvload_5mb_unep\\\\combined_ESVLoad_5Mb_UNEP.c" 2

# 1 "VerifyPAdES_UNEP_simple.c" 1
VerifyPAdES_UNEP_simple()
{
	...
	if(strstr( lr_eval_string("{result}"), lr_eval_string("{VerifyPAdES_simple_response}"))==0)
	{
        lr_end_transaction("VerifyPAdES_UNEP_simple", 1);
		lr_output_message( lr_eval_string("error: expected contains VerifyPAdES_simple_response}, but got {result}"));
	}
	else
	{
		lr_end_transaction("VerifyPAdES_UNEP_simple", 0);
	}
	
    lr_continue_on_error(1);
	return 0;
}
# 12 "c:\\lr_scripts_unep\\esvload_5mb_unep\\\\combined_ESVLoad_5Mb_UNEP.c" 2

# 1 "VerifyPAdES_UNEP_withSignedReport.c" 1
VerifyPAdES_UNEP_withSignedReport()
{
	web_cache_cleanup();
	web_cleanup_auto_headers();
	web_cleanup_cookies();

	lr_output_message(	lr_eval_string("{dataPath}/{VerifyPAdES_withSignedReport_file}"));
	lr_read_file(lr_eval_string("{dataPath}/{VerifyPAdES_withSignedReport_file}"), "request", 0);
	...
	if(strstr( lr_eval_string("{result}"), lr_eval_string("{VerifyPAdES_withSignedReport_response}"))==0)
	{
        lr_end_transaction("VerifyPAdES_UNEP_withSignedReport", 1);
		lr_output_message( lr_eval_string("error: expected contains VerifyPAdES_withSignedReport_response}, but got {result}"));
	}
	else
	{
		lr_end_transaction("VerifyPAdES_UNEP_withSignedReport", 0);
	}
	
    lr_continue_on_error(0);
	return 0;
}
# 13 "c:\\lr_scripts_unep\\esvload_5mb_unep\\\\combined_ESVLoad_5Mb_UNEP.c" 2

# 1 "VerifyCADES_UNEP_simple.c" 1
VerifyCADES_UNEP_simple()
{
	web_cache_cleanup();
	web_cleanup_auto_headers();
	web_cleanup_cookies();

	lr_output_message(	lr_eval_string("{dataPath}/{VerifyCADES_simple_file}"));
	lr_read_file(lr_eval_string("{dataPath}/{VerifyCADES_simple_file}"), "request", 0);
	...
	if(strstr( lr_eval_string("{result}"), lr_eval_string("{VerifyCADES_simple_response}"))==0)
	{
        lr_end_transaction("VerifyCADES_UNEP_simple", 1);
		lr_output_message( lr_eval_string("error: expected contains VerifyCADES_simple_response}, but got {result}"));
	}
	else
	{
		lr_end_transaction("VerifyCADES_UNEP_simple", 0);
	}
    lr_continue_on_error(0);
	return 0;
}
# 14 "c:\\lr_scripts_unep\\esvload_5mb_unep\\\\combined_ESVLoad_5Mb_UNEP.c" 2

# 1 "VerifyCADES_UNEP_withSignedReport.c" 1
VerifyCADES_UNEP_withSignedReport()
{
	...
	if(strstr( lr_eval_string("{result}"), lr_eval_string("{VerifyCADES_withSignedReport_response}"))==0)
	{
        lr_end_transaction("VerifyCADES_UNEP_withSignedReport", 1);
		lr_output_message( lr_eval_string("error: expected contains {VerifyCADES_withSignedReport_response}, but got {result}"));
	}
	else
	{
		lr_end_transaction("VerifyCADES_UNEP_withSignedReport", 0);
	}
    
    lr_continue_on_error(0);
	return 0;
}
# 15 "c:\\lr_scripts_unep\\esvload_5mb_unep\\\\combined_ESVLoad_5Mb_UNEP.c" 2

# 1 "VerifyXAdES_UNEP_simple.c" 1
VerifyXAdES_UNEP_simple()
{
	...
	if(strstr( lr_eval_string("{result}"), lr_eval_string("{VerifyXAdES_simple_response}"))==0)
	{
        lr_end_transaction("VerifyXAdES_UNEP_simple", 1);
		lr_output_message( lr_eval_string("error: expected contains {VerifyXAdES_simple_response}, but got {result}"));
	}
	else
	{
		lr_end_transaction("VerifyXAdES_UNEP_simple", 0);
	}
	
	lr_continue_on_error(0);
	return 0;
}
# 16 "c:\\lr_scripts_unep\\esvload_5mb_unep\\\\combined_ESVLoad_5Mb_UNEP.c" 2

# 1 "VerifyXAdES_UNEP_withSignedReport.c" 1
VerifyXAdES_UNEP_withSignedReport()
{
	...
	if(strstr( lr_eval_string("{result}"), lr_eval_string("{VerifyXAdES_withSignedReport_response}"))==0)
	{
        lr_end_transaction("VerifyXAdES_UNEP_withSignedReport", 1);
		lr_output_message( lr_eval_string("error: expected contains {VerifyXAdES_withSignedReport_response}, but got {result}"));
	}
	else
	{
		lr_end_transaction("VerifyXAdES_UNEP_withSignedReport", 0);
	}
    
    lr_continue_on_error(0);
	return 0;
}
# 17 "c:\\lr_scripts_unep\\esvload_5mb_unep\\\\combined_ESVLoad_5Mb_UNEP.c" 2

# 1 "VerifyXML_UNEP_simple.c" 1
VerifyXML_UNEP_simple()
{
	...
	{
        lr_end_transaction("VerifyXML_UNEP_simple", 1);
		lr_output_message( lr_eval_string("error: expected contains {VerifyXML_simple_response}, but got {result}"));
	}
	else
	{
		lr_end_transaction("VerifyXML_UNEP_simple", 0);
	}
    
    lr_continue_on_error(0);
	return 0;
}
# 18 "c:\\lr_scripts_unep\\esvload_5mb_unep\\\\combined_ESVLoad_5Mb_UNEP.c" 2

# 1 "VerifyXML_UNEP_withSignedReport.c" 1
VerifyXML_UNEP_withSignedReport()
{
	...
	{
        lr_end_transaction("VerifyXML_UNEP_withSignedReport", 1);
		lr_output_message( lr_eval_string("error: expected contains {VerifyXML_withSignedReport_response}, but got {result}"));
	}
	else
	{
		lr_end_transaction("VerifyXML_UNEP_withSignedReport", 0);
	}
    lr_continue_on_error(0);
	return 0;
}
# 19 "c:\\lr_scripts_unep\\esvload_5mb_unep\\\\combined_ESVLoad_5Mb_UNEP.c" 2
...
# 20 "c:\\lr_scripts_unep\\esvload_5mb_unep\\\\combined_ESVLoad_5Mb_UNEP.c" 2
